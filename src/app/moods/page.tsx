...
export default function MoodsPage() {
  ...
  const { state: playerState, playRandomByMood, shuffleByMood, playQueue } = usePlayer();
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ALL_MOODS.map((mood) => {
              ...
              return (
                <div
                  key={mood}
                  className="group relative overflow-hidden rounded-3xl glass border-0 transition-all hover:-translate-y-1 flex flex-col min-h-[240px]"
                >
                  {/* Background Gradient */}
                  <div
