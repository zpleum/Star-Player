    ...
    >
      ...
      <div className="flex flex-col items-center justify-center py-12 px-6">
        {importing ? (
          ...
          <>
            <div className="p-4 rounded-2xl bg-accent/10 mb-4 ring-1 ring-accent/20">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-accent hover:bg-accent-hover text-white text-sm font-medium transition-all active:scale-95"
            >
