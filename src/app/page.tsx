            ...
            {isSelectionMode && (
              <div className="flex items-center gap-2 animate-fade-in">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-surface border border-border hover:bg-surface-hover text-text-primary rounded-full text-sm font-medium transition-all"
                >
                  <ListPlus className="w-4 h-4" />
                  {selectedIds.size === filteredSongs.length ? 'Deselect All' : 'Select All'}
                </button>
                <span className="text-xs text-text-muted font-medium bg-surface px-3 py-2.5 rounded-full border border-border">
